...
axs[0, 0].hist(p_hof_hitters_ba, bins=10, color='red', density=True)
axs[0, 0].hist(p_non_hof_hitters_ba, bins=50, color='teal', alpha=0.7, density=True)
...
axs[0, 1].hist(p_hof_hitters_obp, bins=15, color='red', density=True)
axs[0, 1].hist(p_non_hof_hitters_obp, bins=30, color='teal', alpha=0.7, density=True)
...
axs[0, 2].hist(p_hof_hitters_slg, bins=15, color='red', density=True)
axs[0, 2].hist(p_non_hof_hitters_slg, bins=50, color='teal', alpha=0.7, density=True)
...
axs[1, 0].hist(p_hof_hitters_ops, bins=15, color='red', density=True)
axs[1, 0].hist(p_non_hof_hitters_ops, bins=50, color='teal', alpha=0.7, density=True)
...
# OPS+ for both overlayed
axs[1, 1].hist(p_hof_hitters_opsplus, bins=15, color='red', density=True)
axs[1, 1].hist(p_non_hof_hitters_opsplus, bins=50, color='teal', alpha=0.7, density=True)
...
# Displaying the data
plt.tight_layout()
plt.savefig('hitters_compared.png')
...
axs[0, 0].hist(p_hof_pitchers_eraplus, bins=20, color='red', density=True)
axs[0, 0].hist(p_non_hof_pitchers_eraplus, bins=30, color='teal', alpha=0.6, density=True)
...
axs[0, 1].hist(p_hof_pitchers_fip, bins=12, color='red', density=True)
axs[0, 1].hist(p_non_hof_pitchers_fip, bins=30, color='teal', alpha=0.6, density=True)
...
axs[1, 0].hist(p_hof_pitchers_whip, bins=12, color='red', density=True)
axs[1, 0].hist(p_non_hof_pitchers_whip, bins=30, color='teal', alpha=0.6, density=True)
...
axs[1, 1].hist(p_hof_pitchers_sobb, bins=12, color='red', density=True)
axs[1, 1].hist(p_non_hof_pitchers_sobb, bins=30, color='teal', alpha=0.6, density=True)
...
# Displaying the data
plt.tight_layout()
plt.savefig('pitchers_compared.png')